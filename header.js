...
style="background-image: url('relaseassets/bg.jpg');">
    ...
    <div id="navbar" class="flex w-full items-center justify-between transition-all duration-500 ease-in-out fixed top-0 left-0 right-0 z-[1000] bg-[rgba(4,10,49,0.95)] backdrop-blur-[10px] shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1)]">
<!-- Logo - Solda -->
<div class="flex h-[100px] items-center md:ml-[200px] ml-4"> 
    <img src="assets/reallogo.png" 
        ...
        <button id="menuToggle" class="md:hidden mr-4 z-50 w-10 h-10 flex flex-col items-center justify-center gap-[5px] relative bg-white/10 rounded-lg hover:bg-white/20 transition-all">
...
<nav id="menu" class="fixed md:static top-0 right-0 h-screen md:h-auto w-[350px] max-w-sm md:w-auto bg-gradient-to-br from-[#040a31] to-[#0a1654] md:bg-transparent transform translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out z-40 md:mr-8 lg:mr-12 shadow-2xl md:shadow-none">
    ...
    <ul class="flex flex-col md:flex-row items-stretch md:items-center gap-2 md:gap-1 text-white md:text-white text-base md:text-sm lg:text-base font-medium pt-24 md:pt-0 px-6 md:px-0 pb-8 md:pb-0">
        ...
        <li class="relative group">
            <a href="#header" class="menu-link flex items-center justify-between md:justify-center gap-3 px-5 py-4 md:px-6 md:py-4 lg:px-8 lg:py-4 transition-all duration-300 rounded-xl md:rounded-none bg-white/5 md:bg-transparent hover:bg-white/10 md:hover:bg-transparent border-l-4 md:border-l-0 md:border-b-2 border-transparent hover:border-cyan-400 relative">
                <span class="font-semibold tracking-wide">Ana Sayfa</span>
                <i class="fas fa-chevron-right text-cyan-400 md:hidden text-sm"></i>
                <!-- Desktop hover indicator -->
                <div class="hidden md:block absolute bottom-0 left-0 right-0 h-0.5 bg-cyan-400 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></div>
            </a>
        </li>
        
        <!-- Hakkımızda -->
        <li class="relative group">
            <a href="#about" class="menu-link flex items-center justify-between md:justify-center gap-3 px-5 py-4 md:px-6 md:py-4 lg:px-8 lg:py-4 transition-all duration-300 rounded-xl md:rounded-none bg-white/5 md:bg-transparent hover:bg-white/10 md:hover:bg-transparent border-l-4 md:border-l-0 md:border-b-2 border-transparent hover:border-cyan-400 relative">
        ...
        <!-- İletişim -->
        <li class="relative group">
            <a href="#contact" class="menu-link flex items-center justify-between md:justify-center gap-3 px-5 py-4 md:px-6 md:py-4 lg:px-8 lg:py-4 transition-all duration-300 rounded-xl md:rounded-none bg-white/5 md:bg-transparent hover:bg-white/10 md:hover:bg-transparent border-l-4 md:border-l-0 md:border-b-2 border-transparent hover:border-cyan-400 relative">
        ...
        <div id="menuOverlay" class="hidden fixed inset-0 bg-black/70 backdrop-blur-sm z-30 md:hidden"></div>
    </div>
  ...
  function toggleMenu() {
      ...
      if (isOpen) {
          ...
          menuToggle.style.backgroundColor = 'rgba(255, 255, 255, 0.1)';
      } else {
          // Menüyü aç
          ...
          hamburgerLines[0].style.backgroundColor = '#06b6d4';
          hamburgerLines[1].style.opacity = '0';
          hamburgerLines[2].style.transform = 'rotate(-45deg) translate(5px, -5px)';
          hamburgerLines[2].style.backgroundColor = '#06b6d4';
